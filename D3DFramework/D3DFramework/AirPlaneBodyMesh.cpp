...
PKH::AirPlaneBodyMesh::AirPlaneBodyMesh()
{
	this->vertexCount = 8;
	...
	vertices[0] = Vertex(-1.f, -5.f, -1.f, D3DCOLOR_XRGB(255, 0, 0));
	vertices[1] = Vertex(-1.f, 5.f, -1.f, D3DCOLOR_XRGB(0, 255, 0));
	vertices[2] = Vertex(1.f, 5.f, -1.f, D3DCOLOR_XRGB(0, 0, 255));
	vertices[3] = Vertex(1.f, -5.f, -1.f, D3DCOLOR_XRGB(255, 0, 255));

	vertices[4] = Vertex(-1.f, -5.f, 1.f, D3DCOLOR_XRGB(255, 0, 0));
	vertices[5] = Vertex(-1.f, 5.f, 1.f, D3DCOLOR_XRGB(0, 255, 0));
	vertices[6] = Vertex(1.f, 5.f, 1.f, D3DCOLOR_XRGB(0, 0, 255));
	vertices[7] = Vertex(1.f, -5.f, 1.f, D3DCOLOR_XRGB(255, 0, 255));
	vb->Unlock();
