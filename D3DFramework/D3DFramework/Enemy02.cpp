...
{
	Bullet02* newBullet = new Bullet02(transform->position, Vector3(0.4f, 0.4f, 0.4f), Vector3(0.f, -1.f, 0.f), false);
...
void Enemy02::Pattern02Bullet()
{
	...
	Bullet02* newBullet = new Bullet02(transform->position, Vector3(0.4f, 0.4f, 0.4f), dir, false);
...
void Enemy02::Pattern03Bullet()
{
	...
	for (int i = 0; i < 4; ++i)
	{
		...
		Bullet02* newBullet = new Bullet02(transform->position, Vector3(0.4f, 0.4f, 0.4f), dir[i], false);
